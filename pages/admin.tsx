...
import { SessionList, SessionShow, SeesionEdit, SessionCreate } from '../components/Admin/Session'
...
const App: FC = () => {
  return (
    <>
      ...
      <Admin dataProvider={buildDataProvider({ queries, mutations })} authProvider={buildAuthProvider()} i18nProvider={i18nProvider}>
        <Resource
          name="sessions"
          options={{ label: 'セッション' }}
          list={SessionList}
